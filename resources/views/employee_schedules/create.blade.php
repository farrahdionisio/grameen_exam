<x-app-layout>
    ...
    @section('title') Create Employee Schedule | @endsection

    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Employee Schedule') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('schedules.store') }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                    @csrf       
                        ...
                        <div class="mb-6 md:w-1/2">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="title" type="text" name="title" placeholder="Title" required>
                            @error('title')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-6 md:w-1/2">
                            ...
                            <textarea name="details" class="form-textarea mt-1 block w-full" rows="3" placeholder="Enter schedule details." required></textarea>
                            @error('details')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6 md:w-1/2">
                            ...
                            <input type="time" id="start-time" name="schedule_start_time" min="00:00" max="24:00" required>
                        ...
                        <div class="mb-6 md:w-1/2">
                            ...
                            <input type="time" id="end-time" name="schedule_end_time" min="01:00" max="24:00" required>  
